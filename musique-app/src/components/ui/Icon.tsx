...
const P: Record<IconName, { d: string; fill?: boolean }> = {
  ...
  eye: {
    d: 'M12 5.5C5.5 5.5 2 12 2 12s3.5 6.5 10 6.5S22 12 22 12 18.5 5.5 12 5.5Zm0 4a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5Z',
  },
  trash: {
    d: 'M4.5 7h15M10 7V5.2a1.2 1.2 0 0 1 1.2-1.2h1.6A1.2 1.2 0 0 1 14 5.2V7M6.5 7l.9 12.1a1.6 1.6 0 0 0 1.6 1.4h6a1.6 1.6 0 0 0 1.6-1.4L17.5 7M10 11v6M14 11v6',
  },
