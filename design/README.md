# Buscar — Mobile — design reference
...
- `Buscar-Mobile.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
`assets/` — 0 in this export — and the exported files refer to them there. A
...
Serve the folder (e.g. `python3 -m http.server`) and open `Buscar-Mobile.dc.html`;
